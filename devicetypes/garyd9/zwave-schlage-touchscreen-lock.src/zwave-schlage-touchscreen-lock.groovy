...
metadata {
	...
	tiles(scale: 2) {
		...
		standardTile("alarmMode", "device.alarmMode", inactiveLabel: true, canChangeIcon: false, width: 2, height: 2) {
			...
			state "Off_alarmMode", label: 'Alarm: Off', icon:"st.alarm.alarm.alarm", action:"setAlarmMode", nextState:"unknown_alarmMode"
			state "Alert_alarmMode", label: 'Alert Alarm', icon:"st.alarm.alarm.alarm", action:"setAlarmMode", backgroundColor:"#79b821", nextState:"unknown_alarmMode"
			state "Tamper_alarmMode", label: 'Tamper Alarm', icon:"st.alarm.alarm.alarm", action:"setAlarmMode", backgroundColor:"#79b821", nextState:"unknown_alarmMode"
			state "Kick_alarmMode", label: 'Kick Alarm', icon:"st.alarm.alarm.alarm", action:"setAlarmMode", backgroundColor:"#79b821", nextState:"unknown_alarmMode"
		}
		controlTile("alarmSensitivity", "device.alarmSensitivity", "slider", height: 2, width: 4, inactiveLabel: false) {
			state "alarmSensitivity", label:'Sensitivity', action:"setAlarmSensitivity", backgroundColor:"#ff0000"
		}
		standardTile("autoLock", "device.autoLock", inactiveLabel: true, canChangeIcon: false, width: 2, height: 2) {
		...
		standardTile("vacationMode", "device.vacationMode", inactiveLabel: true, canChangeIcon: false, width: 2, height: 2) {
		...
		standardTile("lockLeave", "device.lockLeave", inactiveLabel: true, canChangeIcon: false, width: 2, height: 2) {
		...
		standardTile("localControl", "device.localControl", inactiveLabel: true, canChangeIcon: false, width: 2, height: 2) {
		...
		standardTile("beeperMode", "device.beeperMode", inactiveLabel: true, canChangeIcon: false, width: 2, height: 2) {
			...
			state "off_beeperMode", label: 'Beeper', icon:"st.alarm.beep.beep", action:"setBeeperMode", nextState:"unknown_beeperMode"
			state "on_beeperMode", label: 'Beeper', icon:"st.alarm.beep.beep", action:"setBeeperMode", backgroundColor:"#79b821", nextState:"unknown_beeperMode"
		}

		main "toggle"
		details(["toggle", "lock", "unlock", "battery", "alarmMode", "alarmSensitivity", "autoLock", "lockLeave", "vacationMode", "beeperMode", "localControl", "refresh"])
	}
}
